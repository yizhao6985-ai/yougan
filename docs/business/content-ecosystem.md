...
目录定义于 `packages/domain/src/models/content-form/` 与 `models/discover/`，推断逻辑在 `utils/discover/publication-metadata.ts`；API/前端同步于 `apps/web/src/lib/discover-taxonomy.ts`。
