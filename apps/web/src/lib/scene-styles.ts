...
export const scene = {
  ...
  composerFloatingInput:
    "[&_[data-slot=input-group]]:rounded-lg [&_[data-slot=input-group]]:border-border/80 [&_[data-slot=input-group]]:bg-card/95 [&_[data-slot=input-group]]:shadow-lg [&_[data-slot=input-group]]:shadow-border/25 [&_[data-slot=input-group]]:backdrop-blur-sm [&_[data-slot=input-group]]:transition-[color,box-shadow,border-color] [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:border-primary/45 [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:ring-[3px] [&_[data-slot=input-group]]:has-[[data-slot=input-group-control]:focus-visible]:ring-primary/15 [&_[data-slot=input-group]]:has-[[data-align=block-start]]:flex-col [&_[data-slot=input-group]]:has-[[data-align=block-start]]:items-stretch",
  studioPanelHeader:
