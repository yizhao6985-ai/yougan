/** 按体裁与媒介生成内容指引片段（generate_draft 等使用） */
import type { ContentFormatId } from "@yougan/domain";

const FORMAT_GUIDANCE: Record<ContentFormatId, string> = {
  note: "图文笔记：开头抓注意力，3-5 个可扫读要点，口语化，正文 300-800 字。",
  short_post: "短帖动态：信息密度高，1-3 段，观点鲜明，正文 50-280 字。",
  article: "长文深度：清晰标题与导语，分节小标题，论据或案例支撑，正文 800-2500 字。",
